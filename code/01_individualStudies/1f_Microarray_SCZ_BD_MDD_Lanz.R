...
if(!file.exists("./data/Microarray_SCZ_BD_MDD_Lanz_normalized.RData")) {
  ...
  save(file="./data/Microarray_SCZ_BD_MDD_Lanz_normalized.RData", datExpr, datMeta, datProbes)
...
load("./data/Microarray_SCZ_BD_MDD_Lanz_normalized.RData")

#pdf("./figures/MicroarrayQC/SCZ_BD_MDD_Lanz_QC.PDF",width=11,height=8.5)
par(mfrow=c(3,4))
...
save(file="./data/Microarray_SCZ_BD_MDD_Lanz_normalized_balanced.RData", datExpr, datMeta, datProbes,model)
...
save(file = "./data/Microarray_SCZ_BD_MDD_Lanz_normalized_CR_regressed.RData", datExpr, datMeta, datProbes)
