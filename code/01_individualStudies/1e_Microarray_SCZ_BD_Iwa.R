...
if(!file.exists("./working_data/Microarray/01_Normalized/Microarray_SCZ_BD_Iwa_normalized.RData")) {
  ...
  rownames(datMeta) = paste(datMeta$Filename,".CEL",sep="")
  ...
  data.affy = ReadAffy(celfile.path="./raw_data/Microarray/Iwa_GSE12649/Iwa_GSE12649_raw/Iwa_GSE12649_raw/", filenames = paste(datMeta$Filename,".CEL",sep=""))
